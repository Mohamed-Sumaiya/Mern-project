   ...
   const confirmDeleteHandler = async () => {
     ...
     try{
      await sendRequest(
        ...
        'DELETE',
         null, // We have no body so we pass null as we cant jump to the last arg value.
        {
    ...
    <li className='place-item'>
     <Card className='place-item__content'>
      ...
      <div className='place-item__image'>
        <img src={`${process.env.REACT_APP_ASSET_BACKEND_URL}/${props.image}`} alt={props.title} />
      </div>
      ...
      <div className='place-item__actions'>
        ...
        {auth.creatorId === props.creatorId && <Button to={`/places/${props.id}`}> EDIT </Button>}
        {auth.creatorId === props.creatorId && <Button danger onClick={showDeleteWarningHandler}> DELETE </Button>}
      </div>
     </Card>
    </li>
</>
